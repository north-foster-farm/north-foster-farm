LEASE: 2026-08-21T05:35:16Z run-105
...
2026-08-21T04:35Z — No-op on input, run 104. INBOX `sequence:` is still
5 against `inbox-processed: 5` with status `waiting-on-james`, so the
new-input guard fired. Took the lease at 04:35:15Z, re-verified `main`
and all four open PR head SHAs against the API, released it. Woke ~60
minutes after the 03:35Z run; hourly cadence holds.
