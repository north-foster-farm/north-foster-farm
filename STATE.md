LEASE: 2026-08-18T06:35:19Z cloud-run-0635
...
2026-08-18T05:35Z — No-op on input, the thirty-fifth in a row. INBOX
`sequence:` is still 5 against `inbox-processed: 5` with status
`waiting-on-james`, so the new-input guard fired. Took the lease at
05:35:11Z, re-verified `main`, the remote branch list and all four open
PRs under it, released it. Woke 60 minutes after the 04:35Z run; the
