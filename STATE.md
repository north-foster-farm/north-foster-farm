LEASE: 2026-08-17T09:35:33Z cloud-5772
...
2026-08-17T08:35Z — No-op on input, the fifteenth in a row. INBOX
`sequence:` is still 5 against `inbox-processed: 5` with status
`waiting-on-james`, so the new-input guard fired. Took the lease at
08:35:37Z, re-fetched the remote under it to confirm nothing landed
between the first fetch and the lease, then released it. Woke 55 minutes
after the 07:40Z run — fifteen consecutive on-schedule firings.
