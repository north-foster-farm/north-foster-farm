LEASE: 2026-08-21T04:35:15Z run-104
...
2026-08-21T03:35Z — No-op on input, run 103. INBOX `sequence:` is still
5 against `inbox-processed: 5` with status `waiting-on-james`, so the
new-input guard fired. Took the lease at 03:35:22Z, re-verified `main`
and all four open PR head SHAs against the API, released it. Woke ~60
minutes after the 02:35Z run; hourly cadence holds.
