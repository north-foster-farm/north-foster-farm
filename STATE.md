LEASE: 2026-08-25T17:35:02Z run-213
...
2026-08-25T16:35Z — No-op on input, run 212. INBOX `sequence:` is still 5
against `inbox-processed: 5` with status `waiting-on-james`, so the
new-input guard fired again; I took the lease at 16:35Z, re-verified the
...
byte-identical for the sixth run running — same head SHAs (#88 5efec4f,
