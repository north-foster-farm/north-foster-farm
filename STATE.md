LEASE: 2026-08-21T09:35:30Z run-109
...
2026-08-21T08:35Z — No-op on input, run 108. INBOX `sequence:` is still
5 against `inbox-processed: 5` with status `waiting-on-james`, so the
new-input guard fired. Took the lease at 08:35:18Z, re-verified `main`
and all four open PR head SHAs against the API, released it. Woke ~60
minutes after the 07:35Z run; hourly cadence holds.
